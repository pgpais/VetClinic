...
interface VeterinaryRepository: JpaRepository<VeterinarianDAO, Long> {
    ...
    @Query("select v from VeterinarianDAO v inner join v.appointments a where v.username = :username and v.frozen = false")
    fun findByUsernameWithAppointment(username: String): Optional<VeterinarianDAO>
